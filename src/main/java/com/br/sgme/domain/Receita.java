...
@Data
@NoArgsConstructor
public class Receita {  private String id;
    ...
    public Receita(String id, Usuario usuario, Cliente cliente, Double valor, LocalDate dataVencimento, StatusContas status, FormasPagamento pagamento, String observacao, LocalDateTime dataCreated, LocalDateTime dataUpdated) {
        this.id = id;
